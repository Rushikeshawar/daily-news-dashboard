...
const ArticleForm = ({ initialData = {}, onSubmit, loading = false }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const processedData = {
      ...
      category: formData.category.toUpperCase(), // Convert to uppercase for backend validation
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        />
        <p className="text-sm text-gray-500 mt-1">Comma-separated tags (e.g., tech, news, ai)</p>
      </div>
